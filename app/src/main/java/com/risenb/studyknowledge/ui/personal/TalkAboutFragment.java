 ...
 *大家谈
 */
public class TalkAboutFragment extends LazyLoadFragment implements MyRefreshLayoutListener, MemberDetailP.MemberDetailFace {
    @ViewInject(R.id.refresh_layout)
    MyRefreshLayout refresh_layout;
    @ViewInject(R.id.rv_member_detail_list)
    RecyclerView talk_about_list;//大家谈列表
    ...
    public void setControlBasis() {
        ...
        mMemberTopicListAdapter = new TalkAboutListAdapter(R.layout.member_detail_topic_item);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getContext());
        talk_about_list.setAdapter(mMemberTopicListAdapter);
        talk_about_list.setLayoutManager(linearLayoutManager);
        refresh_layout.setMyRefreshLayoutListener(this);
        mMemberTopicListAdapter.setEmptyView(R.layout.empty_member_detail_view,(ViewGroup) talk_about_list.getParent());
    }
    ...
    public void onFirstUserVisible() {
        ...
        mMemberDetailP.getMemberDetail(mMemberDetailP.REFRESH,C,attendId,mMemberDetailP
                .TYPE_TALK_ABOUT,TIMESTAMP,PAGE+"",LIMIT);
    }
    /**
     * 刷新
     * @param view
