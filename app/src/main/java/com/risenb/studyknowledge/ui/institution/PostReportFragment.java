 ...
 * 帖子举报
 */
public class PostReportFragment extends BaseFragment implements MyRefreshLayoutListener, BaseQuickAdapter.OnItemChildClickListener, BaseQuickAdapter.OnItemClickListener, ReportManageP.ReportListener {
    @ViewInject(R.id.refresh_layout)
    MyRefreshLayout refresh_layout;
    @ViewInject(R.id.rv_report_list)
    RecyclerView rv_report_list;//帖子举报列表

    private ReportAdapter mReportAdapter;
    private boolean isShowCheck;
    public ReportManageP mReportManageP;
    private int page = 1;
    private int limit = 10;
    private String mComplaintType = "1";//排序类型
    private String mOrderBy = "1";
    private String mCollegeId = "45";
    private boolean isDeleteAll;//删除列表的所有数据
    ...
    public void deleteAll() {
        ...
        mReportManageP.delReport(mCollegeId, "1", chooseId);
    ...
    @Override
    public void reportListData(List<ReportBean.ComplaintListBean> complaintListBeans) {
        if (page == 1) {
            mReportAdapter = new ReportAdapter(R.layout.report_list_item, complaintListBeans);
            ...
            mReportAdapter.addData(complaintListBeans);
            mReportAdapter.notifyDataSetChanged();
        }
    }
