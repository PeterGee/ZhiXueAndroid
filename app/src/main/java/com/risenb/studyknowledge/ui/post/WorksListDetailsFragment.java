...
import com.risenb.studyknowledge.adapter.post.WorkCommentListAdapter;
...
public class WorksListDetailsFragment extends BaseFragment implements MyRefreshLayoutListener, PostsDetailsP.PostsDetailsFace, BaseQuickAdapter.OnItemClickListener {
    ...
    public void postsDetailsSuccess(PostsDetailsBean postContentBean) {
        ...
        if (PAGE == 1) {
            ...
            mAdapter = new WorkCommentListAdapter(R.layout.posts_task_item, postContentBean.getWorkCommentList());
            rv_posts_task.setAdapter(mAdapter);
            //条目点击
            mAdapter.setOnItemClickListener(this);
        } else {
            mrl_posts_task.loadMoreComplete();
            mAdapter.addData(postContentBean.getWorkCommentList());
        }
    }
