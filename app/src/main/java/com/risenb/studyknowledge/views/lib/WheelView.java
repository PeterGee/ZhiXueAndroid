package com.risenb.studyknowledge.views.lib;
...
public class WheelView extends View {
    ...
    private void remeasure() {//重新测量
        ...
        halfCircumference = (int) (itemHeight * (itemsVisible - 1))+Utils.getUtils().getDimen(com.risenb.studyknowledge.R
                .dimen.dm020);
    ...
    private void measureTextWidthHeight() {
        ...
        for (int i = 0; i < adapter.getItemsCount(); i++) {
            ...
            maxTextHeight = rect.height() + Utils.getUtils().getDimen(com.risenb.studyknowledge.R
                    .dimen.dm030);
