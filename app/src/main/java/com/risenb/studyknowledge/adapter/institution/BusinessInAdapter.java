...
public class BusinessInAdapter extends BaseQuickAdapter<BusinessInfoBean,BaseViewHolder>{
    public BusinessInAdapter(@LayoutRes int layoutResId) {
        super(layoutResId);
    }

    public BusinessInAdapter(@LayoutRes int layoutResId, @Nullable List<BusinessInfoBean> data) {
