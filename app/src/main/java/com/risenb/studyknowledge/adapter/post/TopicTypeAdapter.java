...
public class TopicTypeAdapter extends BaseQuickAdapter<CostsListBean,BaseViewHolder> {


    public TopicTypeAdapter(@LayoutRes int layoutResId, @Nullable List<CostsListBean> data) {
